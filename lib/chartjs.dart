...
class Chart {
  ...
  external set ctx(CanvasRenderingContext2D /*CanvasRenderingContext2D|Null*/ v);
  ...
  external static set defaults(dynamic
  /*{
        global: Chart.ChartOptions & Chart.ChartFontOptions;
    }*/
  v);
...
abstract class ChartLegendItem {
  ...
  external factory ChartLegendItem({String text,
    String fillStyle,
    bool hidden,
    String lineCap,
    List<num> lineDash,
...
abstract class ChartTooltipItem {
  ...
  external factory ChartTooltipItem({String xLabel, String yLabel, num datasetIndex, num index});
}
...
abstract class ChartTooltipCallback {
  ...
  external set title(Function /*(item?: ChartTooltipItem[], data?: any) => void*/ v);
  ...
  external set label(Function /*(tooltipItem?: ChartTooltipItem, data?: any) => void*/ v);
  ...
  external factory ChartTooltipCallback({Function /*(item?: ChartTooltipItem[], data?: any) => void*/ beforeTitle,
...
abstract class ChartAnimationParameter {
  ...
  external factory ChartAnimationParameter({dynamic chartInstance, dynamic animationObject});
}
...
abstract class ChartConfiguration {
  ...
  external set type(String /*'line'|'bar'|'radar'|'doughnut'|'polarArea'|'bubble'|String*/ v);
  ...
  external factory ChartConfiguration({String /*'line'|'bar'|'radar'|'doughnut'|'polarArea'|'bubble'|String*/ type,
...
abstract class LinearChartData {
  ...
  external factory LinearChartData({List<dynamic /*String|List<String>*/> labels,
...
abstract class ChartOptions {
  external factory ChartOptions({bool responsive,
...
abstract class ChartFontOptions {
  ...
  external set defaultFontColor(dynamic /*String|CanvasGradient|CanvasPattern|List<String>*/ v);
  ...
  external factory ChartFontOptions({dynamic /*String|CanvasGradient|CanvasPattern|List<String>*/ defaultFontColor,
...
abstract class ChartTitleOptions {
  ...
  external factory ChartTitleOptions({bool display,
...
abstract class ChartLegendOptions {
  ...
  external factory ChartLegendOptions({bool display,
    String position,
    bool fullWidth,
...
abstract class ChartLegendLabelOptions {
  ...
  external factory ChartLegendLabelOptions({num boxWidth,
    num fontSize,
    num fontStyle,
...
abstract class ChartTooltipOptions {
  ...
  external set backgroundColor(dynamic /*String|CanvasGradient|CanvasPattern|List<String>*/ v);
  ...
  external set titleFontColor(dynamic /*String|CanvasGradient|CanvasPattern|List<String>*/ v);
  ...
  external set bodyFontColor(dynamic /*String|CanvasGradient|CanvasPattern|List<String>*/ v);
  ...
  external set footerFontColor(dynamic /*String|CanvasGradient|CanvasPattern|List<String>*/ v);
  ...
  external set borderColor(dynamic /*String|CanvasGradient|CanvasPattern|List<String>*/ v);

  external num get borderWidth;

  external set borderWidth(num v);

  external factory ChartTooltipOptions({bool enabled,
...
abstract class ChartElementsOptions {
  ...
  external factory ChartElementsOptions({ChartPointOptions point,
...
abstract class ChartArcOptions {
  ...
  external factory ChartArcOptions({dynamic /*String|CanvasGradient|CanvasPattern|List<String>*/ backgroundColor,
...
abstract class ChartLineOptions {
  ...
  external factory ChartLineOptions({num tension,
...
abstract class ChartPointOptions {
  ...
  external factory ChartPointOptions({num radius,
...
abstract class ChartRectangleOptions {
  ...
  external factory ChartRectangleOptions({dynamic /*String|CanvasGradient|CanvasPattern|List<String>*/ backgroundColor,
    num borderWidth,
    dynamic /*String|CanvasGradient|CanvasPattern|List<String>*/ borderColor,
...
abstract class ChartLayoutOptions {
  ...
  external factory ChartLayoutOptions({dynamic /*ChartLayoutPaddingObject|num*/ padding});
}
...
abstract class ChartLayoutPaddingObject {
  ...
  external factory ChartLayoutPaddingObject({num top, num right, num bottom, num left});
}
...
abstract class GridLineOptions {
  ...
  external set color(dynamic /*String|CanvasGradient|CanvasPattern|List<String>*/ v);
  ...
  external set zeroLineColor(dynamic /*String|CanvasGradient|CanvasPattern|List<String>*/ v);
  ...
  external factory GridLineOptions({bool display,
...
abstract class ScaleTitleOptions {
  ...
  external factory ScaleTitleOptions({bool display,
    String labelString,
    dynamic /*String|CanvasGradient|CanvasPattern|List<String>*/ fontColor,
    String fontFamily,
    num fontSize,
...
abstract class AngleLineOptions {
  ...
  external factory AngleLineOptions({bool display,
    dynamic /*String|CanvasGradient|CanvasPattern|List<String>*/ color,
    num lineWidth});
}
...
@anonymous
@JS()
abstract class LinearTickOptions
    implements TickOptions<num> {
  ...
  external factory LinearTickOptions({bool beginAtZero,
    num min,
    num max,
    num maxTicksLimit,
    num stepSize,
...
@anonymous
@JS()
abstract class LogarithmicTickOptions
    implements TickOptions<num> {
  external num get min;
...
abstract class ChartDataSets {
  ...
  external factory ChartDataSets({String /*'default'|'monotone'*/ cubicInterpolationMode,
...
abstract class ChartScales<T extends TickOptions> {
  ...
  external set type(String /*'category'|'linear'|'logarithmic'|'time'|'radialLinear'|String*/ v);
  ...
  external factory ChartScales({String /*'category'|'linear'|'logarithmic'|'time'|'radialLinear'|String*/ type,
    bool display,
...
abstract class ChartXAxe
  ...
  external factory ChartXAxe({num categoryPercentage,
    num barPercentage,
    TimeScale time,
...
abstract class ChartYAxe
    implements CommonAxe {
  external factory ChartYAxe({String /*'category'|'linear'|'logarithmic'|'time'|'radialLinear'|String*/ type,
    bool display,
    String id,
    bool stacked,
    String position,
...
@anonymous
@JS()
abstract class LinearScale
    implements ChartScales<LinearTickOptions> {
  external LinearTickOptions get ticks;

  external set ticks(LinearTickOptions v);

  external factory LinearScale({LinearTickOptions ticks,
    String /*'category'|'linear'|'logarithmic'|'time'|'radialLinear'|String*/ type,
    bool display,
    String /*'left'|'right'|'top'|'bottom'|String*/ position,
    GridLineOptions gridLines,
...
@anonymous
@JS()
abstract class LogarithmicScale
    implements ChartScales<LogarithmicTickOptions> {
  external LogarithmicTickOptions get ticks;

  external set ticks(LogarithmicTickOptions v);

  external factory LogarithmicScale({LogarithmicTickOptions ticks,
    String /*'category'|'linear'|'logarithmic'|'time'|'radialLinear'|String*/ type,
    bool display,
    String /*'left'|'right'|'top'|'bottom'|String*/ position,
    GridLineOptions gridLines,
...
abstract class TimeDisplayFormat {
  ...
  external factory TimeDisplayFormat({String millisecond,
    String second,
    String minute,
    String hour,
    String day,
...
@anonymous
@JS()
abstract class TimeScale
    implements ChartScales {
  ...
  external set round(String /*'millisecond'|'second'|'minute'|'hour'|'day'|'week'|'month'|'quarter'|'year'*/ v);
  ...
  external set unit(String /*'millisecond'|'second'|'minute'|'hour'|'day'|'week'|'month'|'quarter'|'year'*/ v);
  ...
  external set minUnit(String /*'millisecond'|'second'|'minute'|'hour'|'day'|'week'|'month'|'quarter'|'year'*/ v);

  external factory TimeScale({TimeDisplayFormat displayFormats,
    bool isoWeekday,
    String max,
    String min,
...
abstract class RadialLinearScale {
  ...
  external factory RadialLinearScale({bool lineArc,
